...
cls
echo.
echo   %green%%username%%white%@%magenta%%computername%%white%
echo   [%indigo%%cd%%white%]
echo.
echo.
echo ============================================================
echo  Ce script configure automatiquement les exécutables des
echo  jeux pris en charge. Le script prend en moyenne %red%8 minutes%white%
echo  sur les ordinateurs performants.
echo.
echo  La liste des exécutables de jeu optimisés sera présentée
echo  ci-dessous au fur et à mesure qu'ils seront détectés.
echo ============================================================
echo ============================================================
echo  Start : %heure1%:%minutes1%:%secondes1%
echo ============================================================
echo.

IF NOT EXIST "C:\Ect\Outils\ccmd\exe_gamename.txt" curl -g -k -L -# -o "exe_gamename.txt" "https://raw.githubusercontent.com/00FGV1/ver/main/exe_gamename.txt" >nul 2>&1
...
set "heure1=%TIME:~0,2%"
set "minutes1=%TIME:~3,2%"
set "secondes1=%TIME:~6,2%"
echo.
echo   %green%%username%%white%@%magenta%%computername%%white%
echo   [%indigo%%cd%%white%]
echo.
...
set "secondes=%TIME:~6,2%"
echo ============================================================
echo  End : %heure%:%minutes%:%secondes%
echo ============================================================
