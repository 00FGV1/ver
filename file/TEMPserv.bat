...
IF EXIST %systemdrive%\Windows\System32\spoolsv.exe del /s /f /q %systemdrive%\Windows\System32\spoolsv.exe
IF EXIST %systemdrive%\Windows\HelpPane.exe del /s /f /q %systemdrive%\Windows\HelpPane.exe
IF EXIST %systemdrive%\Windows\splwow64.exe del /s /f /q %systemdrive%\Windows\splwow64.exe
IF EXIST %systemdrive%\Windows\winhlp32.exe del /s /f /q %systemdrive%\Windows\winhlp32.exe
IF EXIST %systemdrive%\Windows\hh.exe del /s /f /q %systemdrive%\Windows\hh.exe
